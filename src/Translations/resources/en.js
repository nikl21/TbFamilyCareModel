export default {
  ...
  drawer: {
    ...
    screen3: 'ADD PATIENT INFO',
    // screen4: 'PREVIOUS CLASSES',
    screen5: 'PREVIOUS PATIENTS',
  ...
  markScreen: {
    ...
    verificationsubTitle:
      'Has this patient/caregiver been register on the Care Companion App before?',
  ...
  previoussessions: {
    ...
    subtitle: 'You can',
    language: 'view or edit',
    click: 'your previous patient entries by clicking on them',
    marknew: 'EDIT CLASS DETAILS',
    button: 'ADD NEW PATIENT',
    button1: 'ADD NEW PATIENT',
  },
  editclass: {
    date: 'Date',
    time: 'Time',
